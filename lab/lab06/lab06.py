...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions=self.transactions+[Transaction(len(self.transactions),self.balance-amount,self.balance)]
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions=self.transactions+[Transaction(len(self.transactions),self.balance,self.balance)]
